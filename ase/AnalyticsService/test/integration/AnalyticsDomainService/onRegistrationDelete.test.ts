...
describe('AnalyticsDomainService.onRegistrationDelete', () => {
  ...
  it('Does not change database if analytics does not exist', async () => {
    await service.onRegistrationDelete({ eventId: 5, attendeeId: 1 });
